...
public:
    ...
    /**********************************************************************//**
     * \brief Returns the maximum supported <em>material index</em> for this \p 
     * Node type.
     * 
     * \return 7.
     *************************************************************************/
    ...
    /**********************************************************************//**
     * \brief Returns the maximum supported <em>boundary index</em> for this \p 
     * Node type.
     * 
     * \return 31.
     *************************************************************************/
    ...
    /**********************************************************************//**
     * \brief Returns \p true if the \p Node is meant to be regarded as a point 
     *        on an FCC lattice.
     * 
     * \return \p false.
     *************************************************************************/
 ...
 * performed as part of the material calculations, and is very demanding, so it 
 * is recommended to set the \p matSplitRes to something low like 
